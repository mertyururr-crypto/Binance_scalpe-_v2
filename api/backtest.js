...
export default async function handler(req,res){
  try{
    ...
    for(let i=start;i<u.c.length-horizon-1;i++){
      ...
      const advanced=optimizedAt(d,u.o,u.h,u.l,u.c,u.v,i,mtf);
    ...
    return res.status(200).json({
      ...
      methodology:"V7: kapanmış mum + 15m/1h teyidi + rejim filtreleri. Giriş sonraki mum açılışı; TP=1.55 ATR, SL=1.15 ATR; aynı mumda ikisi görülürse LOSS.",
